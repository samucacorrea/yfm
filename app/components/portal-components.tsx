...
export function SchemaScript({data,raw}:{data?:unknown;raw?:string}){const content=raw?.trim()||JSON.stringify(data);if(!content)return null;return <script type="application/ld+json" dangerouslySetInnerHTML={{__html:content}}/>}
