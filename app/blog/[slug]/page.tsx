...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!post) return { title: "Artigo não encontrado | FM Codex" };
  const title = `${post.title.rendered} | FM Codex`;
