...
export async function generateMetadata({ params }: Props): Promise<Metadata> { const tipo = (await params).tipo; return { title: `Passwords de cartas ${tipo} | FM Codex`, description: `Códigos e stats das cartas do tipo ${tipo} em Forbidden Memories.` }; }
